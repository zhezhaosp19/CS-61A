...
def link_to_list(link):
    ...
    if link == Link.empty:
        ...
        return link_first + link_to_list(link.rest)
...
def cumulative_sum(t):
    ...
    if t.is_leaf():
        ...
        sum_branches = [cumulative_sum(b) for b in t.branches]
...
def is_bst(t):
    ...
    """if t.is_leaf():
        ...
        return False
    if t.is_leaf() == False and len(t.branches) <= 2:
...
def in_order_traversal(t):
    ...
    if t.is_leaf():
        ...
        yield from in_order_traversal(t.branches[0]) #iterable of correct in_order_traversal of left
        yield t.label
        yield from in_order_traversal(t.branches[1]) #iterable of correct in_order_traversal of right
